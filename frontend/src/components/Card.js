...
const Card = ({ room, setShowGallery }) => {
    return (
        <div className='p-3 ' >
            ...
            <div className='flex items-cente text-[4.4vw] leading-[4.7vw] lg:text-[20px] lg:leading-[28px] mb-[3px]'>
                <h2 className='font-semibold '>{room.name}</h2>
                {/* <Link href={`gallery/${room.name.toLowerCase()}`} className=' text-blue-400 text-[3vw] lg:text-[18px] lg:leading-[26px] ml-2 border-[1px] border-blue-400 rounded-sm px-1'>View</Link> */}
                <Link href={room.name.toLowerCase()} className=' text-blue-400 text-[3vw] lg:text-[18px] lg:leading-[26px] ml-2 border-[1px] border-blue-400 rounded-sm px-1'>View</Link>
            </div>
            ...
            <div className='pl-0 flex gap-1 flex-wrap mt-2'>
                <div className='p-[1vw] lg:p-[5px] text-slate-600 bg-[#eee] opacity-70 rounded-sm flex ' >
